    ...
    public class SplitIncludeRewritingExpressionVisitor : ExpressionVisitor
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
        {
                ...
                && methodCallExpression.Method.IsGenericMethod)
            {
                    ...
                    && selectMethodCall.Method.GetGenericMethodDefinition() == QueryableMethods.Select)
                {
                    ...
                    return singleResult
                        ? methodCallExpression.Update(methodCallExpression.Object, new[] { source })
                        : source;
                }
            }
        ...
        private LambdaExpression RewriteCollectionInclude(Expression source, LambdaExpression selector, bool singleResult, bool reverseOrdering)
        {
            ...
            return Expression.Lambda(
                new CollectionSelectManyInjectingExpressionVisitor(source, sourceElementType, selectorParameter).Visit(selectorBody),
                selectorParameter);
        }

        private class CollectionSelectManyInjectingExpressionVisitor : ExpressionVisitor
        {
            ...
            private class CloningExpressionVisitor : ExpressionVisitor
            {
