        ...
        private sealed class ShaperProcessingExpressionVisitor : ExpressionVisitor
        {
                ...
                else
                {
                    ...
                    if (_splitQuery)
                    {
                        ...
                        if (_isAsync)
                        {
                            ...
                            relatedDataLoaders = Expression.Lambda<Func<QueryContext, SplitQueryResultCoordinator, Task>>(
                        ...
                        {
                            relatedDataLoaders = Expression.Lambda<Action<QueryContext, SplitQueryResultCoordinator>>(
                ...
                bool trackingQuery)
            {
                    ...
                    || resultCoordinator.DataReaders[collectionId] == null)
                {
                    ...
                    queryContext.ExecutionStrategyFactory.Create().Execute(true, InitializeReader, null);
                ...
                bool trackingQuery)
            {
                    ...
                    || resultCoordinator.DataReaders[collectionId] == null)
                {
                    // Execute and fetch data reader
                    RelationalDataReader dataReader = null;
                    await queryContext.ExecutionStrategyFactory.Create().ExecuteAsync(true, InitializeReaderAsync, null, queryContext.CancellationToken);
